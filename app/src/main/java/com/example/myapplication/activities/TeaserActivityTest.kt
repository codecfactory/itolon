...
class TeaserActivityTest : BaseActivity(),MediaController.MediaPlayerControl {
...
//                finish()
        ...
        try {
            ...
            if (intent.hasExtra("playlistItemData")) {
                ...
                Glide.with(this@TeaserActivityTest).load("http://44.231.47.188" + playlistTrackResult!!.imagePath).placeholder(R.drawable.banner).error(R.drawable.banner).into(profile_image)
            ...
            if (intent.hasExtra("downloadsTrackData")) {
                ...
                Glide.with(this@TeaserActivityTest).load("http://44.231.47.188" + playlistResult!!.imagePath).placeholder(R.drawable.banner).error(R.drawable.banner).into(profile_image)
                donwload_imageview.visibility= View.GONE
            ...
            if (intent.hasExtra("albumDetailTrackData")) {
                ...
                Glide.with(this@TeaserActivityTest).load("http://44.231.47.188" + songListItem!!.imagePath).placeholder(R.drawable.banner).error(R.drawable.banner).into(profile_image)
...
//                    seekBar.max = musicSrv!!.dur
                    seekBar.progress = musicSrv!!.posn
        ...
        previous_song_play_icon.setOnClickListener {
            ...
            try {
                ...
                if(from.equals("fromPlaylist")){
                    ...
                    Glide.with(this@TeaserActivityTest).load(songImagePath).placeholder(R.drawable.banner).error(R.drawable.banner).into(profile_image)
...
//                Constants.mediaPlayer=mediaPlayer
            ...
            mediaPlayer!!.setDataSource(this@TeaserActivityTest,myUri)
                ...
                try {
                    if (b) {
                        ...
                        if(!isPurchased){
                            ...
                            stopPlayer()
                            stopMediaPlayer()
                            ViewUtils.show(this@TeaserActivityTest,"Please purchase the song to listen completely").subscribe {res->
                                if(res){
                                    if(isItemExist()){
                                        ViewUtils.showSnackBar(this@TeaserActivityTest,"Song is already added to cart successfully",true,"")
                                    }else{
                                        ViewUtils.showSnackBar(this@TeaserActivityTest,"Song added to cart successfully",true,"")
                                        Constants.cartArrayList.add(CartModel(songId,songName,songImagePath,songPrice))
                                        RxBus.publish( CartModel(songId,songName,songImagePath,songPrice));
                                    }
                                }
...
//            //get service
//            musicSrv = binder as MusicService
//            //pass list
//            musicSrv!!.setList(Constants.songsArrayList)
//            musicBound = true
//        }
//
